...
where st.cin=d.cin and d.id=s.id and s.id like'%$id%' and d.cin like '%$cin%' and s.etat='refusé'";
else
$requet="select s.id,st.cin,st.nom,st.prenom,st.cv,d.typestage,s.dep,s.encadreur,d.dd,d.df,s.etat from demande d,stage s,stagaire st 
where st.cin=d.cin and d.id=s.id and s.id like'%$id%' and d.cin like '%$cin%' and dep='$dir' and s.etat='refusé'";
