...
$requet="select d.*,s.institut,s.diplome,s.cv from demande d,stagaire s where d.id like '%$id%' and d.cin like'%$cin%' and d.cin=s.cin and etat='en attente'";
...
<div class="container-fluid">
 <div class="panel panel-primary">
     <div class="panel-heading">Liste Demande en attente <?php echo' ('. $n.')';?></div>
