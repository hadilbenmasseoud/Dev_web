...
$requet="select d.*,s.institut,s.diplome,s.cv from demande d,stagaire s where d.id like '%$id%' and d.cin like'%$cin%' and d.cin=s.cin and etat='accepte'";
...
<div class="container-fluid">
 <div class="panel panel-primary">
     <div class="panel-heading">Liste Demande acceptée <?php echo' ('. $n.')';?></div>
