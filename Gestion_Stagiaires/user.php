...
<div class="container" style="margin-top:5%">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Editer Profile</div>
                            <div class="panel-body">
                                <form class="form" name="f" method="POST"    action="editeruser.php" onSubmit="return verifcompte()">
                                <input type="hidden" name='id'  value=<?php echo $user[0]?> > 
                                    <div class="form-group">
                                        <label for="login">Nom Utulisateur</label>
                                        <input type="text" name='login' placeholder="Nom Utulisateur" class="form-control" value=<?php echo $user['login']?> > 
                                    </div>

                                    <div class="form-group">
                                        <label for="email">E-mail</label>
                                        <input type="text" name='email'  placeholder="E-mail" class="form-control"  value=<?php echo $user['email']?>>                            
                                    </div>
